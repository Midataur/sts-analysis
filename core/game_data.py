...
CARDS_LIST = [
    ...
    'Skim',
    'Skim+1',
    'SKIP', # this one isn't technically a card lol
    'Slice',
    'Slice+1',
    'SpiritShield',
    'SpiritShield+1',
...
MISSING = "MISSING" # designates a weird (probably modded token)

SPECIAL_TOKENS = [EMPTY_TOKEN, MISSING]
